...
export default function AboutSection1() {
    ...
    return (
        ...
        >
            {/* Glow decorativo */}
            <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-blue-100 rounded-full blur-3xl opacity-40 pointer-events-none" aria-hidden="true"></div>
            ...
            <TimelineContent
                className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:70px_70px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_100%,#000_70%,transparent_110%)]"
                animationNum={3}
            ...
            <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-black text-slate-900 mb-6 uppercase drop-shadow-[0_1px_2px_rgba(0,0,0,0.15)]">
                    <VerticalCutReveal
                        ...
                        containerClassName="leading-[1.1] text-center justify-center items-center"
                    >
                        20 Anos Protegendo Obras no Nordeste
                    </VerticalCutReveal>
                </h1>
                ...
                <TimelineContent
                    ...
                    customVariants={revealVariants3}
                    timelineRef={heroRef}
                    className="bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 flex w-fit mx-auto gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-white px-8 py-4 rounded-lg font-black text-sm uppercase tracking-widest cursor-pointer"
                >
