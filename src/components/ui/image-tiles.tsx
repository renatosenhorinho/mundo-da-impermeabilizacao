...
export default function ImageReveal({ leftImage, middleImage, rightImage }: ImageRevealProps) {
    ...
    return (
        <>
            <motion.div
                className="relative flex items-center justify-center w-full h-[500px] overflow-hidden sm:overflow-visible"
            ...
            >
                {/* Left Image */}
                <motion.div
                    className="absolute w-[180px] h-[180px] sm:w-[330px] sm:h-[330px] origin-bottom-right overflow-hidden rounded-xl shadow-lg cursor-pointer"
                ...
                >
                    <img
                        src={leftImage.replace('.webp', '-250w.webp')}
                        srcSet={`${leftImage.replace('.webp', '-250w.webp')} 250w, ${leftImage.replace('.webp', '-500w.webp')} 500w`}
                ...
                {/* Middle Image */}
                <motion.div
                    className="absolute w-[180px] h-[180px] sm:w-[330px] sm:h-[330px] origin-bottom-left overflow-hidden rounded-xl shadow-2xl cursor-pointer"
                ...
                >
                    <img
                        src={middleImage.replace('.webp', '-250w.webp')}
                        srcSet={`${middleImage.replace('.webp', '-250w.webp')} 250w, ${middleImage.replace('.webp', '-500w.webp')} 500w`}
                        sizes="(max-width: 768px) 180px, 330px"
                ...
                >
                    <img
                        src={rightImage.replace('.webp', '-250w.webp')}
                        srcSet={`${rightImage.replace('.webp', '-250w.webp')} 250w, ${rightImage.replace('.webp', '-500w.webp')} 500w`}
                        sizes="(max-width: 768px) 180px, 330px"
